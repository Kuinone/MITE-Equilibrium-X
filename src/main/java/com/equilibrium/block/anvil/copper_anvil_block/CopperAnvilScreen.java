...
public class CopperAnvilScreen extends ItemCombinerScreen<com.equilibrium.block.anvil.copper_anvil_block.CopperAnvilScreenHandler> {
    ...
    public CopperAnvilScreen(com.equilibrium.block.anvil.copper_anvil_block.CopperAnvilScreenHandler handler, Inventory inventory, Component title) {
    ...
    protected void renderLabels(GuiGraphics context, int mouseX, int mouseY) {
        ...
        if (i > 0) {
            int j = 8453920;
            Component text;
            if (shouldRejectForCopperAnvil(this.menu.getSlot(0).getItem(),this.menu.getSlot(1).getItem())) {
